...
set FOLDERLIST[0]=PXL_20210928_135258666.jpg
set FOLDERLIST[1]=PXL_20210928_135335141.jpg
...
for /l %%n in (0, 1, 2) do ( 
   ...
   --output_dir="results" ^
   --image_path1="images/%SUBFOLDER%/!FOLDERLIST[%%n]!" --annotation_dir1="annotations/voc_xmls/%SUBFOLDER%" --title1="EML Video Example GT" ^
   --color_gt
